...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/plogg/Downloads/quan-chay-mimi-nuxt-vuetify-fixed","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/plogg/Downloads/quan-chay-mimi-nuxt-vuetify-fixed/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', cacheDriver({"base":"/Users/plogg/Downloads/quan-chay-mimi-nuxt-vuetify-fixed/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/plogg/Downloads/quan-chay-mimi-nuxt-vuetify-fixed/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/plogg/Downloads/quan-chay-mimi-nuxt-vuetify-fixed/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/plogg/Downloads/quan-chay-mimi-nuxt-vuetify-fixed/.data/kv"}));
...
const _hLgeGLqznG7Ie0QgTmvmTK2Jqxs1w0NnOftuUwWnk = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/plogg/Downloads/quan-chay-mimi-nuxt-vuetify-fixed";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"QUÁN CHAY MIMI · Bếp Thiền Lành"};
...
const assets = {
  "/index.mjs": {
    ...
    "mtime": "2026-08-26T08:00:50.344Z",
    "size": 114637,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
